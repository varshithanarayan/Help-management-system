...
<html lang="en">
  ...
  <body class="nav-md">
    <div class="container body">
	 ...
	 error_reporting(0);
	 $a=$_SESSION['username'];
	 $query="SELECT * from deliver_request where username='$a'";
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th>Helper ID </th>
                            <th class="column-title">Amount in ( &#8377 ) </th>
                        ...
                        <tbody>
                          ...
                          <td class=" "> <input type="text" name="p1" value=" <?php echo $data['did']; ?>" ></td>
                           <td class=" "> <input type="text" name="p3" value=" <?php echo $data['item']; ?>" ></td> 
                            <td class=" "> <input type="text" name="p2" value="<?php echo $data['pdate']; ?>" ></td>
